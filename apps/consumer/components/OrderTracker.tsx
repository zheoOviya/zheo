          ...
          return (
            <div key={step.key} className="flex items-start gap-4">
              ...
              <div className="flex flex-col items-center">
                <div
                  className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold transition-colors duration-500 ${
                    isDone
              ...
              <div className="flex-1 pb-6">
                <p
                  className={`text-sm font-semibold transition-colors duration-500 ${
                    isCurrent ? "text-primary-700" : isDone ? "text-neutral-600" : "text-neutral-300"
                  }`}
                >
                  {step.label}
                </p>
