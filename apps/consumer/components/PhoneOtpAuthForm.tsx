...
// ============================================
// Shared phone + OTP auth form (login & sign-up).
// Consumers sign up implicitly: the first "Send OTP" for a new phone
// creates the account, so the same form powers both /login and /signup.
// ============================================

export function PhoneOtpAuthForm({ mode }: { mode: "login" | "signup" }) {
