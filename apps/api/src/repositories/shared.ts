  ...
  if (isMemoryMode()) {
    ...
    try {
      _repos = {
        ...
        sharedPosOrderRepo: new DrizzlePosOrderRepository(db) as unknown as RepoSet["sharedPosOrderRepo"],
        ...
        sharedRoleRepo: new DrizzleRoleRepository(db) as unknown as RepoSet["sharedRoleRepo"],
